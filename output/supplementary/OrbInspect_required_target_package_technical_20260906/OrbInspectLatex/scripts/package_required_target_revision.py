...
def main() -> None:
    ...
    figure_note = ('Figure 1 combines native editable draw.io technical records and an archived '
                   'HCW trace in a pastel-stage style with two independently embedded photographs. '
