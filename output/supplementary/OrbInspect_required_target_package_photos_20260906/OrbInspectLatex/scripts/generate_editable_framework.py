...
def main() -> None:
    ...
    # Mission inputs.
    d.box(24,154,190,132,'#FFFFFF',INK,10,1.4)
    d.photo(28,158,182,124,ASSETS/'iss_nasa_s132e012208.jpg',
            'ISS photograph: NASA / crew of STS-132, 23 May 2010, s132e012208.',
            'https://images.nasa.gov/details-s132e012208')
    d.text(24,294,190,63,'ISS geometry\nand target set',24,True)
    ...
    d.box(280,202,113,80,'#FFFFFF','none',6,0)
    d.photo(282,204,109,76,ASSETS/'camera_alexander_lucke.jpg',
            'Illustrative industrial camera: Alexander Lucke, SVCam-ECO Series black with Tubus, CC BY-SA 3.0. Unmodified photograph.',
            'https://commons.wikimedia.org/wiki/File:SVCam-ECO_Series_black_with_Tubus.JPG')
    d.line([(395,244),(484,211),(484,277),(395,244)],BLUE,1.7)
    for x,y in [(466,225),(478,255),(451,264)]:
